...
export const INITIAL_TEAM: StaffMember[] = [
  { id: 't1', name: 'Rui Jesus', role: 'SKIPPER', active: true, photoUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop' },
  { id: 't2', name: 'Liliana Martins', role: 'STAFF', active: true, photoUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop' },
  { id: 't3', name: 'Nuno Diz', role: 'SKIPPER', active: true, photoUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop' },
  { id: 't4', name: 'Adriano Ferronha', role: 'SKIPPER', active: true, photoUrl: 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=200&h=200&fit=crop' },
  { id: 't5', name: 'António Martinho', role: 'SKIPPER', active: true, photoUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&h=200&fit=crop' },
  { id: 't6', name: 'Ariel', role: 'MARINHEIRO', active: true, photoUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&h=200&fit=crop' },
  { id: 't7', name: 'Diogo Alves', role: 'MARINHEIRO', active: true, photoUrl: 'https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?w=200&h=200&fit=crop' },
  { id: 't8', name: 'Maria Teresa', role: 'STAFF', active: true, photoUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop' },
  { id: 't9', name: 'Telmo Moura', role: 'SKIPPER', active: true, photoUrl: 'https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?w=200&h=200&fit=crop' },
  { id: 't10', name: 'Pedro', role: 'MARINHEIRO', active: true, photoUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop' },
  { id: 't11', name: 'Sucena Fraguito', role: 'MARINHEIRO', active: true, photoUrl: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&h=200&fit=crop' },
  { id: 't12', name: 'Tiago Azevedo', role: 'SKIPPER', active: true, photoUrl: 'https://images.unsplash.com/photo-1543610892-0b1f7e6d8ac1?w=200&h=200&fit=crop' },
  { id: 't13', name: 'José Pereira', role: 'SKIPPER', active: true, photoUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=200&h=200&fit=crop' },
  { id: 't14', name: 'Leandro', role: 'MARINHEIRO', active: true, photoUrl: 'https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?w=200&h=200&fit=crop' }
];
